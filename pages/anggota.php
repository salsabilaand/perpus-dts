...
<div id="content">
	...
	<a target="_blank" href="pages/export_pdf.php"><img src="pdf.png" height="50px" height="50px"></a>
    <a target="_blank" href="pages/export_excel.php"><img src="excel.png" height="50px" height="50px"></a> 
	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td><img src="https://localhost/jwd_11/images/<?php echo $foto; ?>" width=70px height=70px></td>
