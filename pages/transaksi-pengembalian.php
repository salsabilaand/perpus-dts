...
<div id="content">
    ...
    <a target="_blank" href="pages/export_pdf_transaksi_pengembalian.php"><img src="pdf.png" height="50px" height="50px"></a>
    <a target="_blank" href="pages/export_excel_transaksi_pengembalian.php"><img src="excel.png" height="50px" height="50px"></a> 
            ...
            <?php 
                ...
                if($_SERVER['REQUEST_METHOD'] == "POST") { 
                    ...
                    if($pencarian != "") { 
                        ...
                        $query = "SELECT * FROM tbtransaksi WHERE tglkembali IS NOT null LIMIT  $posisi, $batas"; 
