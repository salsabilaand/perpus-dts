...
<div id="content">
    <p id="tombol-tambah-container">
        ...
        <a target="_blank" href="pages/export_pdf_buku.php"><img src="pdf.png" height="50px" height="50px"></a>
        <a target="_blank" href="pages/export_excel_buku.php"><img src="excel.png" height="50px" height="50px"></a> 
    ...
    <table id="tabel-tampil"> 
        ...
        <tbody> 
            ...
            <tr>
                ...
                <td><img src="images/<?php echo $cover; ?>" height=80px></td>
