...
<div id="content">
    ...
    <a href="index.php?p=buku-input" class="tombol">Tambah Buku</a> 
        ...
        <a target="_blank" href="pages/export_pdf_transaksi_peminjaman.php"><img src="pdf.png" height="50px" height="50px"></a>
        <a target="_blank" href="pages/export_excel_transaksi_peminjaman.php"><img src="excel.png" height="50px" height="50px"></a> 
            ...
            <?php 
                ...
                if($_SERVER['REQUEST_METHOD'] == "POST") { 
                    ...
                    if($pencarian != "") { 
                        ...
                        $query = "SELECT * FROM tbtransaksi WHERE LIMIT $posisi, $batas"; 
